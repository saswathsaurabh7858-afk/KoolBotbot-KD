...
global.channelLink = "https://chat.whatsapp.com/KHSCj2MTU8M4FcjXiBzzMI?mode=wwt";
global.ytch = "Mr Saswath";
...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: 'Monu Thap The Goat',
            serverMessageId: -1
        }
    }
};
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, { 
                    text: '📢 *Join our Channel:*\https://chat.whatsapp.com/KHSCj2MTU8M4FcjXiBzzMI?mode=wwt' 
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, { 
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/KHSCj2MTU8M4FcjXiBzzMI?mode=wwt` 
                }, { quoted: message });
                return;
            }
        }
        ...
        if (isBanned(senderId) && !userMessage.startsWith('.unban')) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '❌Stop It Baka,You are banned from using the bot. Contact an admin to get unbanned.',
                    ...channelInfo
                });
            }
            return;
